 ...
 */
final class Version20200611114952 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE episodes (id INT AUTO_INCREMENT NOT NULL, number INT NOT NULL, streaming VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE episodes_saison (episodes_id INT NOT NULL, saison_id INT NOT NULL, INDEX IDX_1D33B16FF965414C (saison_id), INDEX IDX_1D33B16F319135AF (episodes_id), PRIMARY KEY(episodes_id, saison_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
