 ...
 */
final class Version20200611115301 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE saison ADD link VARCHAR(255) DEFAULT NULL, CHANGE serie_id serie_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE saison DROP link, CHANGE serie_id serie_id INT DEFAULT NULL');
