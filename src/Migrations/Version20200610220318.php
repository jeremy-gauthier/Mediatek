 ...
 */
final class Version20200610220318 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE saison CHANGE serie_id serie_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE series CHANGE nb_saisons nb_saisons INT DEFAULT NULL, CHANGE picture picture VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
    }
}
